            ...
            <Card key={org.id} className="bg-white border-slate-100 p-4 hover:border-indigo-500/50 transition-all cursor-pointer group shadow-sm">
               ...
               <div className="flex gap-2">
                  <div className="flex-1 flex flex-col gap-1">
                     <span className="text-[9px] text-slate-400 font-bold uppercase tracking-tight">物業資產</span>
                     <span className="text-xs font-mono font-medium text-slate-600">{org._count.properties}</span>
                  </div>
                  <div className="flex-1 flex flex-col gap-1">
